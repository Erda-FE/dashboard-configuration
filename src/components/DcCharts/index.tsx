...
const basicCharts: Partial<DC.ViewDefMap> = {
  'chart:line': {
    ...
    image: (
      <SvgContainer>
        <path
          d="M497.778 790.756L304.356 651.378l-133.69 108.089-54.044-68.267 182.045-147.911 204.8 145.067 358.4-213.334 45.51 73.956z"
          fill="#25ca64"
        />
        <path
          d="M497.778 534.756L304.356 395.378l-133.69 108.089-54.044-68.267 182.045-147.911 204.8 145.067 358.4-213.334 45.51 73.956z"
          fill="#5d48df"
        />
      </SvgContainer>
    ),
  ...
  'chart:area': {
    ...
    image: (
      <SvgContainer>
        <path
          d="M85.333 824.889S201.956 199.11 352.711 199.11c125.156 0 119.467 227.556 213.333 227.556s76.8-116.623 176.356-116.623c156.444 0 196.267 512 196.267 512H85.333z"
          fill="#25ca64"
        />
        <path
          d="M85.333 824.889s116.623-310.045 267.378-310.045c125.156 0 119.467 113.778 213.333 113.778s76.8-56.889 176.356-56.889c156.444 0 196.267 256 196.267 256H85.333z"
          fill="#5d48df"
        />
      </SvgContainer>
    ),
  ...
  'chart:bar': {
    ...
    image: (
      <SvgContainer>
        <path d="M142.222 526.222h142.222v312.89H142.222z" fill="#25ca64" />
        <path d="M341.333 184.889h142.223V839.11H341.333z" fill="#706EE7" />
        <path d="M540.444 412.444h142.223v426.667H540.444z" fill="#29C287" />
        <path d="M739.556 611.556h142.222V839.11H739.556z" fill="#5d48df" />
      </SvgContainer>
    ),
    // Component: ChartLine,
    Component(props) {
    ...
    image: (
      <SvgContainer>
        <path
          ...
          fill="#5d48df"
        />
        <path d="M540.444 116.622v366.934h366.934C896 287.289 736.71 128 540.444 116.622z" fill="#25ca64" />
      </SvgContainer>
    ),
    Component: ChartPie,
  ...
  'chart:funnel': {
    ...
    image: (
      <SvgContainer>
        <path
          d="M50.102857 168.594286h923.794286l-104.594286 189.44H157.257143L50.102857 168.594286z"
          fill="#5e48df"
          p-id="2979"
        ...
        />
        <path
          d="M190.902857 417.28h645.485714l-104.228571 188.708571H297.691429l-106.788572-188.708571z"
          fill="#25ca64"
          p-id="2980"
        ...
        />
        <path
          d="M330.971429 665.234286h368.64l-105.325715 190.171428H438.857143l-107.885714-190.171428z"
          fill="#5e48df"
          p-id="2981"
  ...
  table: {
    ...
    image: (
      <SvgContainer>
        <path d="M128 412.444h768v85.334H128z m0 199.112h768v85.333H128z" fill="#25ca64" />
        <path
          d="M113.778 184.889V839.11h796.444V184.89H113.778z m28.444 625.778v-512h227.556v512H142.222z m256 0v-512h256v512h-256z m483.556 0H682.667v-512h199.11v512z"
          fill="#5d48df"
        />
      </SvgContainer>
    ),
